...
const TRANSLATIONS: Record<Lang, Translation> = {
  en: {
    ...
    addrVal:      'Siri Dental Line Shope ,OPP GMR grands Palnadu Narasaraopet 522601 ',
  ...
  te: {
    ...
    addrTitle:    'చిరునామా',
    addrVal:      'సిరి డెంటల్, జీఎమ్ఆర్ గ్రాండ్స్ (GMR Grands) ఎదురుగా, పల్నాడు రోడ్, నరసరావుపేట, ఆంధ్రప్రదేశ్ - 522601',
